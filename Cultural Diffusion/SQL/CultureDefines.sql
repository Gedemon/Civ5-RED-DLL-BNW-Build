...
-- 
-- General settings
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_DIFFUSION_ENABLED',		0);	-- Culture diffusion ON/OFF (checked with GAMEOPTION_CULTURE_DIFFUSION, if any is true, then Culture diffusion is activated)
...
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_CITY_FACTOR',	10000);	-- culture value factor used for logarithmic progression (log10)
...
--
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_ABSOLUTE_MAX_PERCENT',  75);
--
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_NORMAL_MAX_PERCENT',	40); -- base percentage, always used
--
...
--
-- Policies modifier
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_TRADITION_OPENER_CONVERSION_RATE',	50);	-- per10000 rate of culture converted to plot owner each turn for tradition opener
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_TRADITION_FINISHER_CONVERSION_RATE', 50);	-- per10000 rate of culture converted to plot owner each turn for tradition finisher
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_SOCIALIST_REALISM_CONVERSION_RATE',  150);	-- per10000 rate of culture converted to plot owner each turn for socialist realism (BNW)
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_MEDIA_CULTURE_CONVERSION_RATE',		175);	-- per10000 rate of culture converted to plot owner each turn for media culture (BNW)
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_NATIONALISM_CONVERSION_RATE',		125);	-- per10000 rate of culture converted to plot owner each turn for nationalism (BNW)

INSERT INTO Defines (Name, Value) VALUES ('CULTURE_LIBRARY_CONVERSION_RATE',		25);	-- per10000 rate of culture converted to city owner each turn for library
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_UNIVERSITY_CONVERSION_RATE',		50);	-- per10000 rate of culture converted to city owner each turn for university
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_PUBLIC_SCHOOL_CONVERSION_RATE',  100);	-- per10000 rate of culture converted to city owner each turn for Public School

------------------------------------------------------------------------------------------------------------------------
--
-- Improvement and units modifier
INSERT INTO Defines (Name, Value) VALUES ('CULTURE_IMPROVEMENT_CONVERSION_RATE',	100);	-- per10000 rate of conversion to plot owner each turn for improvements yielding culture (multiplied by yield)
