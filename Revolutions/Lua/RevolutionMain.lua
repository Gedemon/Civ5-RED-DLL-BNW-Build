...
function CultureRelationTipHandler( control )
	...
	for city in player:Cities() do
		 local citytrouble, percentRevolt, percentRebellion, percentRevolution = GetCityRebellion(city, cultureRelations)
...
function UpdateCultureRelationData()
	...
	for city in player:Cities() do
		 local citytrouble = GetCityRebellion(city, cultureRelations)
		 if citytrouble > maxTrouble then
			maxTrouble = citytrouble
		 end
	end
