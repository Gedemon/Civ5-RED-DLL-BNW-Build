-- RevolutionInfosMain
-- Author: Gedemon
-- DateCreated: 02-May-14 03:01:06
--------------------------------------------------------------

print("Loading Revolution Infos Screen Functions...")
print("-------------------------------------")
...
function UpdateDisplay()
    ...
    for city in player:Cities() do
		...
		local stability, revolt, rebellion, revolution, from = GetCityRebellion(city, cultureRelations)
		local happiness, happy, neutral, unhappy = GetCityHappiness(city, cultureRelations)
		...
		local cityRelationStr = GetPlotRelationHelpString(city:Plot(), cultureRelations)
